  ...
  return (
    <div className="font-sans text-gray-800 p-4" dir="rtl">
      <div className="container mx-auto px-4">
        <h1 className="text-2xl md:text-4xl font-bold mb-6 text-right">ملابس نسائية</h1>
        <p className="text-right mb-8">
          اكتشفي أحدث صيحات الموضة في قسم الملابس النسائية لدينا. نقدم مجموعة متنوعة من التصاميم
          التي تناسب جميع الأذواق والمناسبات.
        </p>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap justify-start gap-4">
            ...
            {/* Add more subcategory buttons as needed */}
          </div>
        </div>
